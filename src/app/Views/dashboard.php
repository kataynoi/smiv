...
<div class="container-fluid">
    ...
    <div class="row">
        ...
        <div class="col-xl-3 col-md-6 mb-4">
            <div class="card shadow h-100 py-2" style="border-left: 2rem solid #1cc88a !important;color: #1cc88a !important;">
                <div class="card-body">
        ...
        <!-- Earnings (Monthly) Card Example -->
        <div class="col-xl-3 col-md-6 mb-4">
            <div class="card  shadow h-100 py-2" style="border-left: 2rem solid #f6c23e !important;color: #f6c23e !important;">
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
        ...
        <!-- Earnings (Monthly) Card Example -->
        <div class="col-xl-3 col-md-6 mb-4">
            <div class="card  shadow h-100 py-2" style="border-left: 2rem solid #fd7e14 !important;color: #fd7e14 !important;">
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
        ...
        <div class="col-xl-3 col-md-6 mb-4">
            <div class="card border-left-danger  shadow h-100 py-2" style="border-left: 2rem solid #e74a3b !important;color: #e74a3b !important;">
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
